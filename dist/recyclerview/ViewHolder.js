...
const ViewHolderInternal = (props) => {
    ...
    const { index, refHolder, layout, onSizeChanged, renderItem, extraData, item, target, CellRendererComponent, ItemSeparatorComponent, trailingItem, horizontal, hidden, inverted, } = props;
    useLayoutEffect(() => {
