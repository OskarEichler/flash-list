...
export class RecyclerViewManager {
    ...
    isInLastRow(index) {
        var _a, _b;
        return (_b = (_a = this.layoutManager) === null || _a === void 0 ? void 0 : _a.isInLastRow(index)) !== null && _b !== void 0 ? _b : false;
    }
    ...
    getItemType(index) {
        var _a, _b, _c;
        return ((_c = (_b = (_a = this.propsRef).getItemType) === null || _b === void 0 ? void 0 : _b.call(_a, this.propsRef.data[index], index, this.propsRef.extraData)) !== null && _c !== void 0 ? _c : "default").toString();
    }
