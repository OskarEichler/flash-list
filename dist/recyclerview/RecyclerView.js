...
const RecyclerViewComponent = (props, ref) => {
    ...
    return (React.createElement(RecyclerViewContextProvider, { value: recyclerViewContext },
        React.createElement(CompatView, { style: [
            ...
            React.createElement(CompatScrollView, { ...rest, horizontal: horizontal, ref: scrollViewRef, onScroll: animatedEvent, maintainVisibleContentPosition: maintainVisibleContentPositionInternal, removeClippedSubviews: false, refreshControl: refreshControl, ...overrideProps },
                scrollAnchor,
                ...
                React.createElement(ViewHolderCollection, { viewHolderCollectionRef: viewHolderCollectionRef, data: data, horizontal: horizontal, renderStack: recyclerViewManager.getRenderStack(), getLayout: (index) => recyclerViewManager.getLayout(index), getAdjustmentMargin: () => {
                        ...
                        : undefined, currentStickyIndex: stickyHeaders ? currentStickyIndex : -1, hideStickyHeaderRelatedCell: stickyHeaderHideRelatedCell, inverted: inverted }),
                renderEmpty,
                renderFooter),
