 ...
 */
export declare function useFlatListBenchmark(flatListRef: React.RefObject<FlatList<any> | null>, callback: (benchmarkResult: BenchmarkResult) => void, params: FlatListBenchmarkParams): {
